...
export class Migration1784099342931 implements MigrationInterface {
    name = 'Migration1784099342931'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_f7320eaa32b94eddf1ac108e3b"`);
