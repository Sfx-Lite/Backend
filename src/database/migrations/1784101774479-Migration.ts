...
export class Migration1784101774479 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_70e8e2d0ad685a0c55eb3d5bd9" ON "wallets" ("deposit_address") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."users_role_enum" AS ENUM('user', 'admin')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."users_kyc_status_enum" AS ENUM('unverified', 'pending', 'verified', 'rejected')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."transactions_type_enum" AS ENUM('deposit', 'internal_transfer', 'withdrawal', 'sweep')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."transactions_status_enum" AS ENUM('pending', 'processing', 'successful', 'failed')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_2f91a8175c49ac211314033e20" ON "transactions" ("from_user_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_cab8dd57a6d6d100a21ddc7467" ON "transactions" ("to_user_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_0deaa0ee5092d45fac99139de7" ON "transactions" ("tx_hash") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_3d623662d4ee1219b23cf61e64" ON "chat_messages" ("conversation_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE "chat_conversations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "user_id" uuid NOT NULL, "title" character varying, CONSTRAINT "PK_ff117d9f57807c4f2e3034a39f3" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_7f9e5689ad3d7f45172fc156fb" ON "chat_conversations" ("user_id") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."beneficiaries_type_enum" AS ENUM('internal', 'external')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_38906de3393c7787c3c89e29d3" ON "beneficiaries" ("user_id") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_08b2603b00992fafcf795624cc" ON "beneficiaries" ("user_id", "identifier") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_c49704abb1730ae4121d5ac9f5" ON "analytics_events" ("user_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_1bfdafcd2d2cf756138def6f38" ON "analytics_events" ("event_name") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_0de5650de773ff3e481357151b" ON "audit_log" ("admin_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_b7fb5009bdbeb7bf0393975335" ON "audit_log" ("entity") `,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b7fb5009bdbeb7bf0393975335"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0de5650de773ff3e481357151b"`,
    );
    await queryRunner.query(`DROP TABLE "audit_log"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_1bfdafcd2d2cf756138def6f38"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c49704abb1730ae4121d5ac9f5"`,
    );
    await queryRunner.query(`DROP TABLE "analytics_events"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_08b2603b00992fafcf795624cc"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_38906de3393c7787c3c89e29d3"`,
    );
    await queryRunner.query(`DROP TABLE "beneficiaries"`);
    await queryRunner.query(`DROP TYPE "public"."beneficiaries_type_enum"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7f9e5689ad3d7f45172fc156fb"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_3b81c8c96263c79a1067693df0"`,
    );
    await queryRunner.query(`DROP TABLE "fx_rates"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ec874b223ad5b6aad19a064481"`,
    );
    await queryRunner.query(`DROP TABLE "kyc_submissions"`);
    await queryRunner.query(`DROP TYPE "public"."kyc_submissions_status_enum"`);
    await queryRunner.query(
      `DROP TYPE "public"."kyc_submissions_doc_type_enum"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8417854ce8bdd0d651c35e1c7c"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b26c5ef5853fd6e0a8680427f6"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0deaa0ee5092d45fac99139de7"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_cab8dd57a6d6d100a21ddc7467"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2f91a8175c49ac211314033e20"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_70e8e2d0ad685a0c55eb3d5bd9"`,
    );
    await queryRunner.query(
